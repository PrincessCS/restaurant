    ...
    return(
        ...
        <section className="hero-section">
            <div className="container">
                <div className="container-text">
                    ...
                    Lorem Ipsum has been the industry's standard dummy text ever since the <br/> 1500.</p>
                     <Link to='/order'><button type="button" className="button">Place Order</button></Link>
                     <p><span><img src="./star.svg" alt="star" /></span>Trustpilot</p>
        ...
        <section className="our-menu-section">
            ...
            <div className="menu-nav-btns">
               <button type="button" onClick={() => setSelectedMenu("burger")} className="button">Place Order</button>
               <button type="button" onClick={() => setSelectedMenu("slides")} className="button">Slides</button>
               <button type="button" onClick={() => setSelectedMenu("drinks")} className="button">Drinks</button>
            </div>

            <Menu selectedMenu={selectedMenu}/>

            <button type="button" className="button">See Full Screen</button>
